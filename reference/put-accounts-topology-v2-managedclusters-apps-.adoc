...
summary: Eine App für einen verwalteten Cluster modifizieren 
---
= Eine App für einen verwalteten Cluster modifizieren
:allow-uri-read: 
...
| forceUpdate | Zeichenkette | Überschrift | Falsch  a| 
...
| protectionStateDetails | Array[link:#type_astra_stateDetail["type_astra_stateDetail"]] | Falsch  a| 
