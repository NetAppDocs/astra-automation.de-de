...
summary: Erstellen Sie eine neue App für einen verwalteten Cluster 
---
= Erstellen Sie eine neue App für einen verwalteten Cluster
:allow-uri-read: 
...
Gibt die gewünschten Werte für die zu erstellende App-API-Ressource an.
...
| namespaceScopedResources | Array[link:#namespaceScopedResources["namespaceScopedResources"]] | Falsch  a| 
...
| resourceSelectionCriteria | Zeichenkette | Wahr  a| 
...
| GVKN | Array[link:#GVKN["GVKN"]] | Wahr  a| 
