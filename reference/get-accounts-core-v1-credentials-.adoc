...
summary: Anmeldeinformationen abrufen 
---
...
Gibt die gespeicherte Credential-API-Ressource im JSON-Antworttext zurück.
...
| Anmeldeinformations-ID | Zeichenkette | Pfad | Wahr  a| 
