...
summary: Alle Benachrichtigungen auflisten 
---
...
| Elemente | array[Beliebig aus: link:#notification_1_3_get_response_body["notification_1.3_get_response_body"], array[]] | Wahr  a| 
