...
summary: Ändern einer Rollenbindung für eine Gruppe, die einem Benutzer zugeordnet ist 
---
= Ändern einer Rollenbindung für eine Gruppe, die einem Benutzer zugeordnet ist
:allow-uri-read: 
