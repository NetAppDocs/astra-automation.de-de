...
summary: Ruft eine Rollenbindung für eine Gruppe ab, die einem Benutzer zugeordnet ist 
---
= Ruft eine Rollenbindung für eine Gruppe ab, die einem Benutzer zugeordnet ist
:allow-uri-read: 
