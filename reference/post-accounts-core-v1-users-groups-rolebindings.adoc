...
summary: Erstellen Sie eine neue Rollenbindung für eine Gruppe, die einem Benutzer zugeordnet ist 
---
= Erstellen Sie eine neue Rollenbindung für eine Gruppe, die einem Benutzer zugeordnet ist
:allow-uri-read: 
