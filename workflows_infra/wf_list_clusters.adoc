...
keywords:  
summary: Sie können die verfügbaren Cluster in einer bestimmten Cloud auflisten. 
---
...
Führen Sie den Workflow aus link:../workflows_infra/wf_list_clouds.html["Clouds auflisten"] Wählen Sie dann die Cloud mit den Clustern aus.



== Schritt 2: Listen Sie die Cluster auf
